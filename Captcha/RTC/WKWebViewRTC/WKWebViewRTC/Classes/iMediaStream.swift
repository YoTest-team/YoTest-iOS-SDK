...
class iMediaStream : NSObject {
	...
	@discardableResult func addTrack(_ pluginMediaStreamTrack: iMediaStreamTrack) -> Bool {
    ...
    @discardableResult func removeTrack(_ pluginMediaStreamTrack: iMediaStreamTrack) -> Bool {
